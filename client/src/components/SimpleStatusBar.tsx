...
interface SimpleStatusBarProps {
  connectionStatus?: 'online' | 'offline' | 'emergency';
}
              ...
              <div className="p-2 max-h-72 overflow-auto">
                <div className="p-2 text-sm border-b border-gray-100">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium">EmergencyPay Update</p>
                      <p className="text-gray-500 text-xs mt-1">Your offline payment system is ready to use in case of UPI outages.</p>
